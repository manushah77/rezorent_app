            ...
            children: [
              Text(
                ...
                style: AppTextStyles.customText(
                  fontSize: labelTitleSize ?? 14,
                  color: labelColor ?? Color(0xff515151),
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            border: OutlineInputBorder(
              borderSide: BorderSide(color: enabledBorderColor ?? AppColors.transparent),
            ...
            focusedBorder: OutlineInputBorder(
              borderSide: BorderSide(color: enabledBorderColor ?? AppColors.primary),
              borderRadius: BorderRadius.circular(focusedBorder ?? 16.sp),
            ),
            ...
            errorBorder: OutlineInputBorder(
              borderSide: BorderSide(color: enabledBorderColor ?? AppColors.negativeRed),
              borderRadius: BorderRadius.circular(errorBorder ?? 16.sp),
            ),
            disabledBorder: OutlineInputBorder(
              borderSide: BorderSide(color: enabledBorderColor ?? AppColors.transparent),
              borderRadius: BorderRadius.circular(disabledBorder ?? 16.sp),
            ),
            focusedErrorBorder: OutlineInputBorder(
              borderSide: BorderSide(color: enabledBorderColor ?? AppColors.primary),
              borderRadius: BorderRadius.circular(focusErrorBorder ?? 16.sp),
            ),
            errorMaxLines: 2,
